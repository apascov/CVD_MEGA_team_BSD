...
and loaded in the app using caching:
...
8. Deployment on Streamlit Community Cloud
...
Note: Make sure requirements.txt is in your repository root, as Streamlit Cloud will automatically install dependencies from it.
